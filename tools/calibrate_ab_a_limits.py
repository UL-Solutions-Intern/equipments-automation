...
print("=" * 70)
print("A cursor limit calibration")
print("=" * 70)
print()
print("Step 0:")
...
points = [
    ("a_search_left_limit", "Move mouse to the LEFT A limit: just inside the graph, not outside."),
    ("a_search_right_limit", "Move mouse to the RIGHT A limit: inside the graph, same horizontal line if possible."),
]
...
print("=" * 70)
print()
print("Recommended B release remains:")
print("b_release_overshoot_target_rel=(0.545, 0.635)")
